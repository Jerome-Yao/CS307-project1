...
public class LowLoad {
    ...
    public void load() throws Exception {
        ...
        try {
            CompletableFuture.allOf(clientFuture).get();
            CompletableFuture.allOf(salesFuture).get();
            CompletableFuture.allOf(productFuture).get();
        ...
        try {
            CompletableFuture.allOf(productModelFuture).get();
            CompletableFuture.allOf(contractFuture).get();
        } catch (ExecutionException e) {
        ...
        try {
            ...
            System.err.println("last load failed");
            e.printStackTrace();
        } finally {
            executor.shutdown();
        }
